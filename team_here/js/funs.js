...
const home_btns = document.querySelectorAll('.home-book-btns span')
let catagories = document.querySelectorAll('.Catagories .links a')
let catagories_sub_catagory_books = document.querySelectorAll('.Catagories .links .sub-catagory')
